...
async def get_ai_doc_types():
    doc_types = [
        ...
        {"id": "ub-04-new",             "label": "UB-04 (CMS-1450 Specimen)", "icon": "🏦", "category": "Billing"},
        {"id": "eob-explanation",       "label": "EOB",                     "icon": "📄", "category": "Insurance"},
        {"id": "acord-25",              "label": "ACORD 25",                "icon": "📜", "category": "Insurance"},
        {"id": "acord-new",             "label": "ACORD 25 (2018/09)",      "icon": "📜", "category": "Insurance"},
        {"id": "police-report",         "label": "Police Report",           "icon": "🚔", "category": "Legal"},
        {"id": "police-report-new",     "label": "Police Report (Specimen)", "icon": "🚔", "category": "Legal"},
        ...
        {"id": "litigation-document-new", "label": "Litigation Complaint (Specimen)", "icon": "🏛️", "category": "Legal"},
