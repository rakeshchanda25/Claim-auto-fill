...
def _resolve_jurisdiction(doc_type, jurisdiction):
    from ai_doc_generator.registry import layout_axis
...
def build_synthetic_data(doc_type: str, scenario: str = "general", anchor_date=None,
                         jurisdiction=None) -> dict:
    doc_type = resolve_doc_type(doc_type)
    jurisdiction = _resolve_jurisdiction(doc_type, jurisdiction)
    ...
    if doc_type == "medical-record":
        ...
        report_state = jurisdiction or random.choice(_STATES)
